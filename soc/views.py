...
def local_posts_list_view(request, *args, **kwargs):
    return render(request, 'posts/list.html')


def local_posts_detail_view(request, post_id, *args, **kwargs):
    return render(request, 'posts/detail.html', context={'post_id': post_id})


def local_posts_profile_view(request, username, *args, **kwargs):
